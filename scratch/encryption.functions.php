<?php
	...
	function encrypt_using_passkey($thing_to_encrypt,$pass_key){
	...
	function decrypt_using_passkey($encrypted_thing_with_salt,$pass_key){
	...
	function decrypt_using_private_key($encrypted_thing,$private_key_contents){
	...
	function encrypt_using_public_key($thing_to_encrypt,$public_key_contents){
