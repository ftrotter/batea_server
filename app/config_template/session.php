...
/*
	...
	IMPORTANT : you must change the domain in this file to match the domain you are hosting from

	//dont use subdomains and then the system will work across them..
...
return array(
	...
	'expire_on_close' => false, //new in Laravel 4.2
